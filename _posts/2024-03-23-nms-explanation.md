...
1.NMS giải quyết vấn đề gì ?
------
...
3.Thuật toán NMS hoạt động như thế nào ?
------
...
Chạy inference để xem output của model có gì nào, mình sẽ lấy tấm hình này để demo 
