...
**2. Efficient Computing:**  I also work on analysing computational bottlenecks in deep learning systems and improving efficiency through algorithmic redesign (fusion, sampling, quantisation), heterogeneous computing strategies.


**3. Reinforcement Learning:**  With a background in Automation and Control Engineering, I am particularly interested in improving training efficiency and convergence in complex environments. I design methods and systems that enable reinforcement learning models to learn faster, generalise better, and require less interaction data.



[MonoRevo Inc.]: https://monorevo.net/